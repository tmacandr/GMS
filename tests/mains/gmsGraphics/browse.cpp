...
//    the map data from the BROWSE library of the DCW database.
//
   ...
   switch (theMsg)
      {
       case WM_CREATE:
          {
                 const double initialZoomFactor = 20000.0;
...

{
   ...
   tempImage = g_theBrowseMap->gmsGetBrowseEbrImage (gmsBrowse_CO);
...

{
   ...
   tempImage = g_theBrowseMap->gmsGetBrowseEbrImage (gmsBrowse_DV);
...

{
   ...
   tempImage = g_theBrowseMap->gmsGetBrowseEbrImage (gmsBrowse_GR);
