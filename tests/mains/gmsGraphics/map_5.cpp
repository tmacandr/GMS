//----------------------------------------------------------------------------
// File : map_5.cpp
// Date : 10-Nov-99 : initial definition - evolve from "map_3"
//        14-Nov-99 : make use of new lat/long grid object
//
// Description:
...
static const gmsEarthModelType g_earthModel = gmsEllipsoid;

static gmsMapClass   theMap
                        (g_earthModel,
                         gmsGetBrowseFullPath("libref/edg"));

static const double deltaDeg = 10.0;

static gmsLatLongGridClass theGrid(deltaDeg, g_earthModel);
...

{
       WNDCLASSEX wc;
       MSG        theMsg;
       TCHAR      instanceName[] = TEXT("map_5_Demo");
       BOOL       isOk;
   ...
   wc.lpszMenuName  = MAKEINTRESOURCE(IDR_Map_5_Main_Menu);
